package com.mainsoft.tareas.config;

import com.mainsoft.tareas.handler.AutenticacionHandler;
import com.mainsoft.tareas.handler.RegistroUsuarioHandler;
import com.mainsoft.tareas.handler.TareaHandler;
import com.mainsoft.tareas.model.dto.*;
import com.transporte.logistica.model.dto.*;
import com.transporte.tareas.model.dto.*;
...
public class RouterFunctionConfig {
    ...
    @Bean
    public RouterFunction<ServerResponse> routerFunctionAdministracionUsuarios(AutenticacionHandler autenticacionHandler, RegistroUsuarioHandler registroUsuarioHandler, TareaHandler tareaHandler) {
        return RouterFunctions.route(RequestPredicates.POST("/v1/login"), autenticacionHandler::login)
                .andRoute(RequestPredicates.POST("/v1/registrarse"), registroUsuarioHandler::registrarUsuario);
    }
    ...
    @Bean
    public RouterFunction<ServerResponse> routerFunctionAdministracionTareas(AutenticacionHandler autenticacionHandler, RegistroUsuarioHandler registroUsuarioHandler, TareaHandler tareaHandler) {
